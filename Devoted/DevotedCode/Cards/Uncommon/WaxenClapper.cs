...
public class WaxenKnell() : DevotedCard(1, CardType.Attack, CardRarity.Uncommon, TargetType.AllEnemies)
{
    ...
    public override IEnumerable<CardKeyword> CanonicalKeywords => [ CardKeyword.Exhaust, MyCustomEnums.Toll ];
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        WaxenKnell cardSource = this;
